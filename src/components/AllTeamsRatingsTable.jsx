...
const AllTeamsRatingsTable = () => {
  ...
  const { allTeamsRatings, loading } = useSelector(
    (state) => state.judgeDashboard
  );
  console.log("allTeamsRatings: ", allTeamsRatings);
  ...
  const getTeamGroups = () => {
    ...
    const groups = allTeamsRatings.map(
      (team) => team.team_code?.split("_")[0] || team.team_group || "Unknown"
    );
  ...
  return (
    <Box sx={{ width: "100%" }}>
        ...
        <Table size="medium" stickyHeader>
          <TableHead>
            <TableRow>
              ...
              <StyledHeaderCell>Problem Statement</StyledHeaderCell>
              <StyledHeaderCell>Total Score</StyledHeaderCell>
              <StyledHeaderCell
                align="center"
              ...
              <StyledHeaderCell>Judges</StyledHeaderCell>
          ...
          <TableBody>
            {currentPageTeams.map((team) => {
              ...
              const teamGroup =
                team.team_code?.split("_")[0] || team.team_group;
              // Parse rating
              const rating = parseFloat(team.average_rating) || 0;
              // Format rounds
              const rounds = team.rounds
                ? team.rounds.split(",").map((r) => r.trim())
                : [];
              // Format judges
              const judges = team.judge_names
                ? team.judge_names.split(",").map((j) => j.trim())
                : [];
              ...
              return (
                ...
                >
                  ...
                  <StyledTableCell>
                    ...
                    >
                      {team.total_score} / {team.round_count * 75}
                    </Typography>
                  </StyledTableCell>
      ...
      >
        ...
        >
          <Box>
            <Typography variant="h6">Team Evaluation Details</Typography>
            {selectedTeam && (
                              ...
                              <Grid container spacing={1} sx={{ mt: 1 }}>
                                <Grid item xs={6}>
                                  <Typography variant="body2">
                                    Innovation:{" "}
                                    <strong>{evaluation.innovation}</strong>
                                  </Typography>
                                </Grid>
                                <Grid item xs={6}>
                                  <Typography variant="body2">
                                ...
                                <Grid item xs={6}>
                                  <Typography variant="body2">
                                    Feasibility:{" "}
                                    <strong>{evaluation.feasibility}</strong>
                                  </Typography>
                                </Grid>
                                <Grid item xs={6}>
                                  <Typography variant="body2">
                                ...
                                <Grid item xs={6}>
                                  <Typography variant="body2">
                                    Collaboration:{" "}
                                    <strong>{evaluation.collaboration}</strong>
                                  </Typography>
                                </Grid>
                                <Grid item xs={6}>
                                  <Typography variant="body2">
                                    Presentation:{" "}
                                    <strong>{evaluation.presentation}</strong>
                                  </Typography>
                                </Grid>
                                <Grid item xs={6}>
                                  <Typography variant="body2">
