        ...
        >
            {user ? (
                <>
                    <MenuItem disabled>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <Avatar sx={{ width: 30, height: 30, mr: 1, bgcolor: theme.palette.primary.main }}>
                    ...
                    {user.role === 'admin' && (
                        <>
                            <MenuItem onClick={() => { handleMobileMenuClose(); navigate('/admin/dashboard'); }}>
                                <DashboardIcon sx={{ mr: 1, fontSize: 20 }} />
                                Dashboard
                            </MenuItem>
                            <MenuItem onClick={() => { handleMobileMenuClose(); navigate('/admin/register'); }}>
                ...
                <>
                    <MenuItem disabled>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <Avatar sx={{ width: 30, height: 30, mr: 1, bgcolor: theme.palette.secondary.main }}>
                                <TeamIcon />
                            </Avatar>
                            <Box>
                                <Typography variant="body1" sx={{ fontWeight: 500 }}>{teamAuth.team.name}</Typography>
                                <Typography variant="caption" color="text.secondary">Team Portal</Typography>
                            </Box>
                        </Box>
                    </MenuItem>
                    <Divider />
                    <MenuItem onClick={() => { handleMobileMenuClose(); navigate('/teamDashboard'); }}>
                        <DashboardIcon sx={{ mr: 1, fontSize: 20 }} />
                        Dashboard
                    </MenuItem>
                ...
                <>
                    ...
                    <MenuItem onClick={() => { handleMobileMenuClose(); navigate('/team/register'); }}>
                        <PersonAddIcon sx={{ mr: 1, fontSize: 20 }} />
                        Team Register
                    </MenuItem>
                </>
        ...
        >
            {user ? (
                <>
                    ...
                    {user.role === 'admin' && (
                        <>
                            <MenuItem onClick={() => { handleUserMenuClose(); navigate('/admin/dashboard'); }}>
                                <DashboardIcon sx={{ mr: 1, fontSize: 20 }} />
                                Dashboard
                            </MenuItem>
                            <MenuItem onClick={() => { handleUserMenuClose(); navigate('/admin/register'); }}>
                                <PersonAddIcon sx={{ mr: 1, fontSize: 20 }} />
                                Register User
                            </MenuItem>
                            <Divider />
                ...
                <>
                    <MenuItem onClick={() => { handleUserMenuClose(); navigate('/teamDashboard'); }}>
                        <DashboardIcon sx={{ mr: 1, fontSize: 20 }} />
                        Dashboard
                    </MenuItem>
                    <MenuItem onClick={handleTeamLogout}>
